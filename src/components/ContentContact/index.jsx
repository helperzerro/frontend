...
export default function ContentContext() {
  return (
    <div>
      <div className="flex justify-center bg-black w-full text-center font-extrabold text-white text-6xl p-10 lg:my-10">
      ...
      <div className="flex flex-wrap p-3 mb-20 justify-center items-center md:justify-between md:flex-nowrap border">
        <div className="text-center py-4 md:w-10/12">
          <FaMapMarkedAlt
            ...
            className="mx-auto"
          ></FaMapMarkedAlt>
          <h3 className="text-white font-bold text-2xl m-4 w-9/12 mx-auto">
            Dengan senang hati kami tunggu anda di kantor kami untuk
            berkonsultasi
          </h3>
          <p className="text-white m-4 text-xl">Alamat:</p>
          ...
          <p className="text-2xl font-bold text-white my-10">0813 8042 6117</p>
        </div>
